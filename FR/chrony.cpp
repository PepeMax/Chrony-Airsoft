...
float poids_bille = 0.20; // Grammage de la bille
float distance_capteur = 0.1; // Distance entre les deux capteurs en mètre
...
float fps_bille; // Nombres de FPS de votre réplique
